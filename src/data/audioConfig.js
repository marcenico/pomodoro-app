export const audioConfig = {
  // Different chord progressions for different session types
  pomodoro: {
...
export const audioSettings = {
  ...
  enabled: true,
  fallbackToBeep: true, // Use simple beep if Web Audio API fails
  beepFrequency: 800, // Frequency for fallback beep
  beepDuration: 200 // Duration for fallback beep in milliseconds
};
